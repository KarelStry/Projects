...
class NumericalODE:
    ...
    def euler_method(self, f, y0, t0, t_end, dt):
        """
    ...
    def improved_euler_method(self, f, y0, t0, t_end, dt):
        """
    ...
    def runge_kutta_method(self, f, y0, t0, t_end, dt):
        """
...
# Example usage
t_values, y_values = solver.euler_method(f, y0, t0, t_end, dt)
t_values_improved, y_values_improved = solver.improved_euler_method(f, y0, t0, t_end, dt)
t_values_rk, y_values_rk = solver.runge_kutta_method(f, y0, t0, t_end, dt)
